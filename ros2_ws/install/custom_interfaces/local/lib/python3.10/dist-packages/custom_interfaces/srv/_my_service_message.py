...
class MyServiceMessage_Response(metaclass=Metaclass_MyServiceMessage_Response):
    ...
    __slots__ = [
        '_navigation_successfull',
        '_message',
    ]

    _fields_and_field_types = {
        'navigation_successfull': 'boolean',
        'message': 'string',
    }
    ...
    def __init__(self, **kwargs):
        assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
            'Invalid arguments passed to constructor: %s' % \
            ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.navigation_successfull = kwargs.get('navigation_successfull', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.navigation_successfull != other.navigation_successfull:
            return False
    ...
    @builtins.property
    def navigation_successfull(self):
        """Message field 'navigation_successfull'."""
        return self._navigation_successfull

    @navigation_successfull.setter
    def navigation_successfull(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'navigation_successfull' field must be of type 'bool'"
        self._navigation_successfull = value
...
class Metaclass_MyServiceMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.srv.MyServiceMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from custom_interfaces.srv import _my_service_message
...
class MyServiceMessage(metaclass=Metaclass_MyServiceMessage):
    from custom_interfaces.srv._my_service_message import MyServiceMessage_Request as Request
    from custom_interfaces.srv._my_service_message import MyServiceMessage_Response as Response
